...
RULES: dict[str, list[str]] = {
    ...
    "Shelter & evacuation": [
        r"\bshelter\b", r"\bshelters\b", r"\bshelterbox\b",
        r"\bopvang\b", r"\bevacuat\w+\b", r"\bevacué\w*\b", r"\bevakuac\w+\b",
        r"\bschuilplaats\b", r"\bnotunterkunft\b", r"\bonderdak\b",
        r"\brefuge\b", r"\brefugee\b", r"\basylum\b",
        r"\bhébergement\b", r"\bhebergement\b",
        r"\brefugio\b", r"\brifugio\b", r"\bschronisko\b",
        r"\bhomeless\w*\b", r"\bwohnungslos\w*\b", r"\bsans[- ]abri\b",
        r"\bsans[- ]domicile\b",
        r"\bfeantsa\b",
    ],
    "Food & basic needs": [
        r"\bfood bank\b", r"\bfood banks\b", r"\bfoodbank\b", r"\bfood aid\b",
        r"\bvoedselbank\b", r"\bvoedselbanken\b",
        r"\bbanco alimentare\b", r"\bbanco alimentar\b",
        r"\bbanque alimentaire\b", r"\bbanques alimentaires\b",
        r"\btafel\b",  # German Tafel = food bank
        r"\bbanca pentru alimente\b", r"\bb[aă]nci pentru alimente\b",
        r"\bmaisto banka[s]?\b",
        r"\bpotravinov[aá] banka\b",
        r"\bbanki żywności\b", r"\bbank[óu]?w żywności\b",
        r"\bbanka hrane\b", r"\bbanaka hrane\b",
        r"\btoidupank\b", r"\bélelmiszerbank\b", r"\belelmiszerbank\b",
        r"\bpārtikas banka\b", r"\bpartikas banka\b",
        r"\bfødevarebanken\b", r"\bfoedevarebanken\b",
        r"\bmatsentralen?\b", r"\bmatbank\b",
        r"\bruoka[- ]?apu\b",
    ...
    "Psychosocial support": [
        ...
        r"\bcrisis line\b", r"\bcrisis helpline\b",
        r"\bsuicide\b", r"\bsuicid\w+\b",
        ...
        r"\btelefonseelsorge\b", r"\bsamaritans\b",
        r"\buttsička\w+\b", r"\bseelsorge\b",
        r"\bzelfmoordpreventie\b", r"\btelefono amico\b",
    ],
    "Community resilience": [
        r"\bcommunity resilience\b", r"\bcommunity-based\b",
        r"\bgemeenschapsweerbaarheid\b", r"\blokale weerbaarheid\b",
        r"\bneighbourhood\b", r"\bneighborhood\b",
        r"\bbuurthulp\b", r"\bbuurtnetwerk\b",
        r"\bcommunity preparedness\b", r"\blocal preparedness\b",
        r"\bresiliencia comunit\w+\b", r"\bresilienza di comunit\w+\b",
        r"\blokalna odporno\w+\b", r"\bodporno\w+\b",
        r"\bveerkracht\b",
        r"\bready scotland\b", r"\bready\.scot\b",
        r"\bsąsiedzk\w+\b", r"\bsasiedzk\w+\b",
        r"\bresilienz\w+\b",
    ],
    "Crisis response": [
